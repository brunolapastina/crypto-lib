...
// This header defines all the test cases defined in the document
// The Advanced Encryption Standard Algorithm Validation Suite(AESAVS)
// from NIST. Link: http://csrc.nist.gov/groups/STM/cavp/documents/aes/AESAVS.pdf

// The only tests defined here are the ones with known key, known input and known output

struct AES128TestCase
{
   uint8_t Key[16];
   uint8_t Input[16];
   uint8_t Output[16];
...
// B.1. Keysize = 128
const AES128TestCase AppendixB_128[] = 
{
   {
...
// C.1. Keysize = 128
const AES128TestCase AppendixC_128[] =
{
   {
...
// D.1.Keysize = 128
const AES128TestCase AppendixD_128[] =
{
   {
      { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
...
// E.1. Keysize = 128
const AES128TestCase AppendixE_128[] =
{
   {
      { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
      { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
...
// Other tests
const AES192TestCase OtherTests_192[] = 
{
   //AES-192 from the original spec
   {
